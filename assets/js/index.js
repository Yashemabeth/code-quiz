const musicQuestions = [
    {
      title: "How many Singers are in the pop group Little Mix?",
      options: ["4", "6", "8", "10"],
      correctOption: "4",
    },
    {
      title: "How many Singers were in the RnB group Destiny's Child?",
      options: ["2", "3", "1", "4"],
      correctOption: "4",
    },
    {
      title: "How many Singers were in the boy band One Direction ?",
      options: ["7", "6", "5", "10"],
      correctOption: "5",
    },
  ];
  ...
  let count = musicQuestions.length * 5;
  // let count = 5;
  ...
  const verifyAnswer = function (event) {
    ...
    if (target.getAttribute("name") === "option") {
      ...
      if (currentQuestionIndex < musicQuestions.length) {
  ...
  const renderQuestionContainer = function () {
    ...
    const currentQuestion = musicQuestions[currentQuestionIndex];
